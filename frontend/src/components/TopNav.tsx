  ...
  return (
    <div className="navbar flex justify-between items-center gap-2 sm:gap-4 bg-base-100 py-2 px-3 sm:px-5">
      ...
      <div className="flex items-center gap-1 sm:gap-3 p-1">
        {/* Language switch */}
        <div className="flex flex-none bg-base-200 rounded-full p-1">
          <button
            onClick={() => setLanguage(language === "en" ? "es" : "en")}
            className="btn btn-ghost btn-circle btn-xs text-xs font-black w-14 h-8 cursor-pointer"
        ...
        <div className="dropdown dropdown-end">
          ...
          >
            {userId === "" ? (
              <li>
                <div className="p-3 text-sm text-gray-500">{t("signin_prompt_notif")}</div>
              </li>
          ...
          >
            ...
            <li className="text-base-content mt-2 sm:hidden">
              ...
              >
                ...
                {theme === "halloween" ? t("light_mode") : t("dark_mode")}
              </button>
            </li>
